...
export default function Projects() {
    const listProjects = [
        {id:1, image:movie, title:'Netflix Movie Recomendation', description:'Movie recomendation system using machine learning Deployed on hugging face'},
                    ...
                    listProjects.map((project)=>{
                        ...
                        <div key={project.id} className='p-4'>
                            <div className='h-full border-2 border-orange-400 shadow-[0_0_15px_rgba(255,165,0,0.7)] border-opacity-60 rounded-lg overflow-hidden'>
                                <img src={project.image} alt={project.title} className='w-full h-auto lg:h-60 md:h-36 sm:h-24 object-cover object-center' />
                                <div className='p-6'>
                                    <h2 className='tracking-widest text-xl title-font font-medium text-gray-200 mb-1'>{project.title}</h2>
